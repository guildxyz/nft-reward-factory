...
async function main() {
  ...
  const basicGuildRewardNFT = (await BasicGuildRewardNFT.deploy()) as Contract;
  ...
  console.log("BasicGuildRewardNFT deployed to:", await basicGuildRewardNFT.getAddress());
}
